...
public class MCPDispatcher {
  ...
  private static final String RAG_INSTRUCTIONS =
      ...
      3. Use vector_search for dense or sparse nearest-neighbor retrieval with a pre-computed query vector.
      4. Use hybrid_search when vector retrieval must be combined with bounded graph expansion or full-text ranking.
      5. Use full_text_search for indexed lexical retrieval and sample_records for small bounded examples.
